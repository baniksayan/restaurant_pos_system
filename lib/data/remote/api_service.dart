...
class ApiService {
  ...
  static Future<CreateOrderHeadApiResModel?> saveOrderHead({
    ...
    try {
      ...
      if (kDebugMode) {
        debugPrint('[API Call] saveOrderHead - Table: $orderChannelId');
        debugPrint('[API Call] Request Body: ${requestModel.toJson()}');
      }
      ...
      if (kDebugMode) {
        ...
        debugPrint('[API Call] saveOrderHead Response: ${response.body}');
      }
      ...
      if (kDebugMode) {
        debugPrint('[API Error] saveOrderHead: $e');
      }
      return null;
    }
  }
  ...
  static Future<OrderChannelListApiResponseModel?> getOrderChannelListByType({
    ...
    try {
      ...
      if (kDebugMode) {
        debugPrint('[Table Manager] API Call - OrderChannelListByType');
        debugPrint(
          '[Table Manager] Request URL: ${ApiConstants.baseUrl}Setting/OrderChannelListByType',
        );
        debugPrint('[Table Manager] Request Body: $requestBody');
      }
      ...
      if (kDebugMode) {
        debugPrint('[Table Manager] Response Status: ${response.statusCode}');
        debugPrint('[Table Manager] Response Body: ${response.body}');
      }
      ...
      if (response.statusCode == 200) {
        ...
        if (kDebugMode) {
          debugPrint('[Table Manager] API Failed: ${response.statusCode}');
        }
        return null;
      }
    } catch (e) {
      if (kDebugMode) {
        debugPrint('[Table Manager] API Error: $e');
      }
      return null;
    }
  }
  ...
  static Future<Map<String, dynamic>?> getRunningTable({
    ...
    try {
      ...
      if (kDebugMode) {
        debugPrint('[API] getRunningTable request: $requestBody');
      }
      ...
      if (kDebugMode) {
        debugPrint('[API] getRunningTable status: ${response.statusCode}');
        debugPrint('[API] getRunningTable body: ${response.body}');
      }
      ...
      if (kDebugMode) debugPrint('[API] getRunningTable error: $e');
      return null;
    }
  }
  ...
  static Future<OrderDetailApiResponseModel?> getOrderDetailById({
    ...
    try {
      ...
      if (kDebugMode) {
        ...
        debugPrint('[Cart Loaded] Response Status: ${response.statusCode}');
      }
      ...
      if (kDebugMode) {
        debugPrint('[API Error] getOrderDetailById: $e');
      }
      return null;
    }
  }
  ...
  static Future<Map<String, dynamic>?> updateOrderHeadStatus({
    ...
    try {
      ...
      if (kDebugMode) {
        debugPrint('[API Error] UpdateOrderHeadStatus: $e');
      }
      return null;
    }
  }
