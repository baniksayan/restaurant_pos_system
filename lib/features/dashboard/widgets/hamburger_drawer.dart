...
class _HamburgerDrawerState extends State<HamburgerDrawer> {
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 6),
                          // Look back at any past bill or KOT and
                          // reprint/view it — one entry, two tabs, rather
                          // than splitting bills and KOTs across separate
                          // drawer rows.
                          _buildCleanNavTile(
                            title: 'Reprint',
                            subtitle: 'Past bills and KOTs',
  ...
  /// Tile for navigating to the Ready to Collect screen.
  /// Maintained with clean neutral styling without green highlighting or badge quantity,
  /// as active notifications are displayed directly via the main AppBar indicator.
  Widget _buildReadyToCollectTile() {
    return _buildCleanNavTile(
      title: 'Ready to Collect',
      subtitle: 'Collect prepared orders from kitchen',
