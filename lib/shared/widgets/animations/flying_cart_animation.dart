...
class _FlyingCartAnimationState extends State<FlyingCartAnimation>
  ...
  void initState() {
    ...
    _scaleAnimation = TweenSequence<double>([
      ...
      TweenSequenceItem(tween: Tween<double>(begin: 0.8, end: 0.6), weight: 40),
      TweenSequenceItem(tween: Tween<double>(begin: 0.6, end: 1.2), weight: 20),
      TweenSequenceItem(tween: Tween<double>(begin: 1.2, end: 0.0), weight: 10),
