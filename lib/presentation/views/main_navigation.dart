...
class _MainNavigationState extends State<MainNavigation> {
                ...
                children: [
                  ...
                  WaiterDashboardView(
                    onTableSelected: (tableId, tableName) {
                      navProvider.selectTable(tableId, tableName, navProvider.selectedLocation ?? '');
                    },
                  ),
                  // Menu Tab
                  MenuView(
  ...
  Widget _buildBottomNavigationBar(BuildContext context, NavigationProvider navProvider) {
          ...
          child: Stack(
            children: [
                            ...
                            children: [
                              Stack(
                                ...
                                children: [
                                  ...
                                  if (index == 2 && cartProvider.totalItems > 0 && navProvider.currentIndex != 2)
                                    Positioned(
                                      right: -8,
                                      top: -8,
                                      child: Container(
                              ...
                              Text(
                                ...
                                style: TextStyle(
                                  fontSize: 11,
                                  fontWeight: navProvider.currentIndex == index ? FontWeight.bold : FontWeight.normal,
                                  color: navProvider.currentIndex == index
              ...
              AnimatedPositioned(
                ...
                left: (navProvider.currentIndex * MediaQuery.of(context).size.width / 5)
  ...
  Widget _buildFloatingActiveTab(AnimatedCartProvider cartProvider, NavigationProvider navProvider) {
