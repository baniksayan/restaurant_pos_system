...
class _BillingPageState extends State<BillingPage> {
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              Expanded(
                child: _buildInfoItem('Table', widget.cartItems.first.tableName),
              ),
              Expanded(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          _buildAmountRow('Total Amount:', '₹${total.toStringAsFixed(2)}', isTotal: true),
        ],
      ),
    );
  }
      ...
      child: Column(
        ...
        children: [
          ...
          IntlPhoneField(
            ...
            validator: (value) {
              if (value != null && value.number.isNotEmpty && value.number.length < 7) {
    ...
    return SizedBox(
      ...
      child: ElevatedButton.icon(
        ...
        label: Text(
          _generating
              ? 'Generating Bill...'
              : (_customerPhone?.isNotEmpty == true ? 'Generate & Send Bill' : 'Generate Bill'),
  ...
  Future<void> _sendToWhatsApp(dynamic billBytes) async {
    try {
      ...
      final cleanPhone = _customerPhone!.replaceAll('+', '').replaceAll(' ', '');
      final message = 'Hello! Your restaurant bill for Order #${widget.orderNumber} is ready. Total: ₹${total.toStringAsFixed(2)}';
      ...
      if (await canLaunchUrl(Uri.parse(whatsappUrl))) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('WhatsApp not available. Bill shared via other apps.'),
